...
export async function monster(message: Discord.Message, args: string[]): Promise<void> {
  ...
  try {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField('STR', monster.strength, true)
      .addField('DEX', monster.dexterity, true)
      .addField('CON', monster.constitution, true)
      .addField('INT', monster.intelligence, true)
      .addField('WIS', monster.wisdom, true)
      .addField('CHA', monster.charisma, true)
